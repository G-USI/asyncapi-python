...
from src.asyncapi_python_codegen.parser import extract_all_operations, load_document_info
from asyncapi_python.kernel.document import Operation, Channel, Message

class TestParserBasics:
    """Test basic parser functionality."""
    
    def test_load_document_info(self):
    ...
    def test_extract_simple_operations(self):
    ...
    def test_extract_rpc_operations(self):
...
class TestMessageExtraction:
    ...
    def test_message_payloads_preserved(self):
...
class TestDataclassRepr:
    ...
    def test_operation_repr_valid_python(self):
...
class TestInternalReferences:
    ...
    def test_internal_channel_refs(self):
    ...
    def test_internal_message_refs(self):
...
class TestRelativeReferences:
    ...
    def test_relative_ref_chain(self):
        ...
        assert payload["properties"]["department"]["enum"] == ["engineering", "sales", "marketing"]
    
    def test_different_relative_paths(self):
