...
@pytest.mark.asyncio
async def test_subscriber_nacks_and_stops_on_regular_exception(mock_operation, mock_codec, mock_wire_with_consumer):
...
@pytest.mark.asyncio
async def test_subscriber_rejects_and_continues_on_reject_exception(mock_operation, mock_codec, mock_wire_with_consumer):
...
@pytest.mark.asyncio
async def test_subscriber_continues_after_reject_but_stops_on_regular_exception(mock_operation, mock_codec, mock_wire_with_consumer):
...
@pytest.mark.asyncio
async def test_rpc_server_nacks_and_stops_on_regular_exception(mock_operation, mock_codec, mock_wire_with_consumer):
...
@pytest.mark.asyncio
async def test_rpc_server_rejects_and_continues_on_reject_exception(mock_operation, mock_codec, mock_wire_with_consumer):
